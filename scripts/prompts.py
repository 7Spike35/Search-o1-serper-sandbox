...
def get_hybrid_search_code_instruction(MAX_SEARCH_LIMIT):
    """Get instruction for math problems with code execution and search capability."""
    return (
        "Analyze and solve the following problem step by step.\n\n"
        "You have access to two types of tools to help you solve problems more effectively.\n\n"
        "**Available Tools:**\n"
        "1. **Web Search Tool:**\n"
